...
android {
    namespace = "com.reotech.mortgage_calculator"
    ...
    defaultConfig {
        ...
        applicationId = "com.reotech.mortgage_calculator"
        ...
        // Inject AdMob App ID from key.properties into the manifest
        manifestPlaceholders["admob_app_id"] = keystoreProperties["admobAppId"] as String? ?: "ca-app-pub-3940256099942544~3347511713"
    }
